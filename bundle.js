...
/***/ function(module, exports, __webpack_require__) {
	...
	var drawShape = function drawShape(x, y) {
	...
	var sketchProc = function sketchProc(p5) {
	    ...
	    _.times(3, function (i) {
	        return rightWalkers.push(new Walker(0, -100 * i));
	    });

	    _.times(3, function (i) {
	        return leftWalkers.push(new Walker(0, -100 * i));
	    });
	    ...
	    p5.setup = function () {
	        ...
	        p5.smooth();
	        p5.background.apply(undefined, rColor);
	    ...
	    p5.draw = function () {
	        p5.fill.apply(undefined, rColor);
	        p5.pushMatrix();
	        p5.translate(centerX, centerY);

	        rightWalkers.forEach(function (w) {
	            return w.tick({ direction: "left", inf: mouse_x * mouse_y });
	        });
	        leftWalkers.forEach(function (w) {
	            return w.tick({ direction: "right" });
	        });
	        ...
	        _.times(50, function (i) {
	            return p5.text("imm.aterial", 50, i * 28);
	        });
	        p5.popMatrix();
